...
Usage: main.py [-h] [-o OUTPUT] [--output-dir OUTPUT_DIR] [--cookies-file COOKIES_FILE] [--keep-encrypted] [-v] [--from-browser]
               [--browser {chrome,edge,firefox}]
               content_asin
Example:
python src/main.py B07JZ7PW6F --from-browser --browser firefox
